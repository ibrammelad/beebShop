      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form action="{{route('update_drivers' , $user->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('PATCH')
              <div class="row">
                <div class="col-12 col-sm-6">
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <br>
                      <img src="{{ \Illuminate\Support\Facades\URL::to('/') }}/images/drivers/ids/{{ $user->idImage!=null ? $user->idImage : "download1.jpg"}}"alt="driver" width="100" height="100">
                      @error('idImage')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                    </div>
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <br>
                      <img src="{{ \Illuminate\Support\Facades\URL::to('/') }}/images/drivers/licenseCar/{{ $user->licenseCar!=null ? $user->licenseCar : "download1.jpg"}}"alt="driver" width="100" height="100">
                      @error('licenseCar')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                    </div>
...
{{--                  </div>--}}
                  <div class="form-group">
                    <div class="controls">
                      <label> Is Helper </label>
                      <div class="form-group">
                        <input type="checkbox" name="is_helper" id="switch15" switch="bool" @if($user->is_helper == 1 )checked @endif  value="{{$user->is_helper ==1?1:0}}" />
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <br>
                      <img src="{{ \Illuminate\Support\Facades\URL::to('/') }}/images/drivers/{{ $user->image!=null ? $user->image : "download.jpg"}}"alt="driver" width="100" height="100">
                      @error('image')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                    </div>
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <br>
                      <img src="{{ \Illuminate\Support\Facades\URL::to('/') }}/images/drivers/license/{{ $user->license!=null ? $user->license : "download.jpg"}}"alt="driver" width="100" height="100">
                      @error('license')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                    </div>
