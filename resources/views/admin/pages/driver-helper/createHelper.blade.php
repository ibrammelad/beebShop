      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form action="{{route('store_helpers')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('POST')
              <div class="row">
...
{{--                  </div>--}}
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input type="checkbox" name="is_driver" id="switch15" switch="bool"  value="1" checked/>
