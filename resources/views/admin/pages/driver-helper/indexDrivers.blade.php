    ...
    <div class="card">
      <div class="card-body">
        <div class="col-12 d-flex align-items-center justify-content-end pb-1">
          <a href="{{route('create_drivers')}}" class="btn btn-sm btn-success">Add Driver</a>
        </div>
        <!-- datatable start -->
          ...
          <table class="table" id="userDatatable">
            ...
            @foreach ($users as $index=>$user)
              <tr>
                ...
                <td>
                  <a href="{{route('edit_drivers',$user->id)}}" class="badge badge-primary"><i class="bx bx-edit-alt"></i></a>
                  ...
                  <div class="modal fade" id="exampleModal{{$user->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form method="POST" action="{{route('delete_drivers',$user)}}">
                          @csrf
                          @method('DELETE')
