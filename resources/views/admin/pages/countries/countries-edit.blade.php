      ...
      <div class="card-body">
            ...
            <div class="page=form">
                ...
                <fieldset class="fieldset">
                  ...
                  <form method="post" action="{{route('update_area' ,$area->id)}}">
                    @csrf
                    @method('PATCH')
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <div class="control-container">
                                    ...
                                    <input class="form-control" name="name" value="{{$area->name}}" placeholder="Enter countery name">
                                  @if ($errors->has('name'))
                      ...
                      <div class="row">
                        <div class="col-md-4 form-group">
                          ...
                          <select class="form-control" name="status">
                            <option @if($area->status == 1) selected @endif value="1">Active</option>
                            <option @if($area->status == 0) selected @endif value="0">InActive</option>
                          </select>
                        </div>
                      </div>
