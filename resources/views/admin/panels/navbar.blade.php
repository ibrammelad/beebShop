...
{{--          </li>--}}
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              ...
              <span>
                <img class="round" src="{{ \Illuminate\Support\Facades\URL::to('/') }}/images/users/{{ auth()->user()->image!=null ? auth()->user()->image : "download.jpg"}}" alt="avatar" height="40" width="40"></span>
            </a>
