...
; (function (window, document, $) {
  ...
  // Navigation Search cities Close
  ...
  // Navigation Search cities Close on click of app-content
  ...
  $(".search-input .input").on("keyup", function (e) {
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        $.getJSON(assetPath + "data/" + $filename + ".json", function (
          data
        ) {
